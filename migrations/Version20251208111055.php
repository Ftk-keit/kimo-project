 ...
 */
final class Version20251208111055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE property (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(50) NOT NULL, type VARCHAR(255) NOT NULL, price NUMERIC(10, 2) NOT NULL, views INT NOT NULL, status VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, bedroom INT NOT NULL, bathroom INT NOT NULL, surface VARCHAR(50) NOT NULL, characteristic JSON NOT NULL, media VARCHAR(255) NOT NULL, type_transaction VARCHAR(255) NOT NULL, location VARCHAR(255) NOT NULL, city VARCHAR(50) NOT NULL, transaction_id INT DEFAULT NULL, owner_id INT NOT NULL, INDEX IDX_8BF21CDE2FC0CB0F (transaction_id), INDEX IDX_8BF21CDE7E3C61F9 (owner_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, price VARCHAR(50) NOT NULL, commission VARCHAR(50) NOT NULL, date DATE NOT NULL, status VARCHAR(255) NOT NULL, seller_id INT NOT NULL, buyer_id INT NOT NULL, property_id INT NOT NULL, INDEX IDX_723705D18DE820D9 (seller_id), INDEX IDX_723705D16C755722 (buyer_id), INDEX IDX_723705D1549213EC (property_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
